...
python3 -W ignore policy_hooks/run_training.py -c new_specs.nav_domain_deterministic.new_env_hyperparam \
						...
						-descr simple_nav_domain_policyguide_obstacleavoid_lidar360randinit_debugframelowthresh \
                                                -assume_true
