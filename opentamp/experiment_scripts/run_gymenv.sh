...
python3 -W ignore policy_hooks/run_training.py -c new_specs.pointer_domain.new_env_hyperparam \
                                                ...
                                                -mask -hln 2 -lln 2 -hldim 256 -lldim 256 \
                                                -retime -vel 0.3 -eta 5 -softev \
                                                -lr_schedule fixed \
                                                -imwidth 256 -imheight 256 \
                                                -hist_len 2 -prim_first_wt 20 -lr 0.01 \
                                                -hllr 0.0001 -contlr 0.01 -lldec 0.0001 -hldec 0.0001 \
                                                --permute_hl 1 \
						...
						-descr pointer_pilot_shorttrain_deterministicstart_noobsimit_noprec_simpleenvobs_multinet
# sleep 1800 
# pkill -f run_train -9
# pkill -f ros -9
# sleep 5
