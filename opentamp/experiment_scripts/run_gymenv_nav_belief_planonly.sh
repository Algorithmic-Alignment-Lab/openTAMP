...
TRIAL_NAME='nav_dettrial_fullobs_bimodalwideavoid_highinitdebug3'

python3 -W ignore policy_hooks/run_training.py -c new_specs.nav_domain_belief_onlyobs.new_env_hyperparam \
