...
from opentamp.envs.drake_gym_env_nav_belief import DrakeGymEnvNavWrapper
...
def refresh_config(no=NUM_OBJS, nt=NUM_TARGS):
    ...
    config = {
        ...
        'meta_file': opentamp.__path__._path[0] + '/new_specs/drake_nav_domain_belief/namo_purenav_meta.json',
        'acts_file': opentamp.__path__._path[0] + '/new_specs/drake_nav_domain_belief/namo_purenav_acts_belief.json',
        'prob_file': opentamp.__path__._path[0] + '/new_specs/drake_nav_domain_belief/namo_purenav_prob.json',
        ...
        'sensor_dims': {
                ...
                utils.PAST_MJCOBS_ARR_ENUM: 20 * DrakeGymEnvNavWrapper().observation_space.shape[0],
