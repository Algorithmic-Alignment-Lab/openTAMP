...
import opentamp.new_specs.spot_arm_domain_deterministic.gym_prob as prob
...
from opentamp.envs.spot_blank_gym_env import SpotBlankEnvWrapper
...
def refresh_config(no=NUM_OBJS, nt=NUM_TARGS):
    ...
    config = {
        ...
        'attr_map': ATTRMAP,
        'agent_type': GymAgent,
        'gym_env_type': SpotBlankEnvWrapper,
        'mp_solver_type': ToySolver,
        'll_solver_type': ToySolver,
        'meta_file': opentamp.__path__._path[0] + '/new_specs/spot_arm_domain_deterministic/pointer_meta.json',
        'acts_file': opentamp.__path__._path[0] + '/new_specs/spot_arm_domain_deterministic/pointer_acts.json',
        'prob_file': opentamp.__path__._path[0] + '/new_specs/spot_arm_domain_deterministic/pointer_prob.json',
        ...
        'sensor_dims': {
                ...
                utils.MJC_SENSOR_ENUM: SpotBlankEnvWrapper().observation_space.shape[0],
                # utils.EE_ENUM: 2,
